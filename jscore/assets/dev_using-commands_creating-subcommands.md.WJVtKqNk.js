import{_ as i,c as a,o as n,ae as e}from"./chunks/framework.CqV5Rifv.js";const r=JSON.parse('{"title":"Creating Subcommands","description":"","frontmatter":{},"headers":[],"relativePath":"dev/using-commands/creating-subcommands.md","filePath":"dev/using-commands/creating-subcommands.md"}'),p={name:"dev/using-commands/creating-subcommands.md"};function l(t,s,h,E,k,o){return n(),a("div",null,s[0]||(s[0]=[e(`<h1 id="creating-subcommands" tabindex="-1">Creating Subcommands <a class="header-anchor" href="#creating-subcommands" aria-label="Permalink to &quot;Creating Subcommands&quot;">​</a></h1><p>In FabricMC, the syntax for creating a subcommand is similar to adding an argument. This is also the case for JSCore.</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// module/my_module/entry.js</span></span>
